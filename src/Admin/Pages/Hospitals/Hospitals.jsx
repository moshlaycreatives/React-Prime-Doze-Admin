...
const Hospitals = () => {
    ...
    const hospitals = useAppSelector((state) => state.hospitals.items);
    ...
    const filteredRows = useMemo(() => {
        ...
        return rows;
    }, [hospitals, search, country, sortBy]);

    const handleNavigate = () => {
        navigate("/admin/hospitals-profile")
    }
    ...
    return (
        <Box>
            ...
            <TableFilterBar
                ...
                searchAriaLabel="Search hospitals"
                country={country}
