...
const LabProfile = () => {
    const { stats, info, images, allTests, requests, tabs } = useAppSelector(
        (state) => state.labProfile
    );
    ...
    const filteredRequests = useMemo(() => {
        ...
        return requests.filter((row) => row.status === status);
    }, [activeTab, requests]);
                        ...
                        >
                            <Box sx={{ display: "flex", flexDirection: "column", gap: 2.25 }}>
                                {[
                                    ...
                                    { label: "Test Types", value: info.testTypes },
