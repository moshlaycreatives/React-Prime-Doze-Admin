...
const Labs = () => {
    ...
    const labs = useAppSelector((state) => state.labs.items);
        ...
        if (search.trim()) {
            ...
            rows = rows.filter(
                (row) =>
                    ...
                    String(row.testTypes).includes(query) ||
