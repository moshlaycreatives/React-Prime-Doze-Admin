...
const OpticalStoreDetails = ({ open, onClose, store }) => {
    const detailRows = [
        { label: "Email", value: store.email },
        { label: "Phone", value: store.phone },
        { label: "Delivery Fee", value: store.deliveryFee },
        { label: "City", value: store.city },
        { label: "Store Address", value: store.storeAddress, multiline: true },
        { label: "Opening Time", value: store.openingTime },
        { label: "Closing Time", value: store.closingTime },
    ];
    ...
    return (
        ...
        >
            ...
            >
                <Typography sx={dialogTitleSx}>Store Details</Typography>
                <IconButton
                    aria-label="Close"
                    onClick={onClose}
                    sx={{
            ...
            >
                ...
                <DetailSection title="About">{store.about}</DetailSection>
            </Box>
        </Dialog>
    );
};

OpticalStoreDetails.propTypes = {
...
export default OpticalStoreDetails;
