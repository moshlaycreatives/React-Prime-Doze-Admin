...
const PharmacyDetails = ({ open, onClose, pharmacy }) => {
    const detailRows = [
        { label: "Email", value: pharmacy.email },
        { label: "Phone", value: pharmacy.phone },
        { label: "Delivery Fee", value: pharmacy.deliveryFee },
        { label: "City", value: pharmacy.city },
        { label: "Lab Address", value: pharmacy.labAddress, multiline: true },
        { label: "Opening Time", value: pharmacy.openingTime },
        { label: "Closing Time", value: pharmacy.closingTime },
    ];
    ...
    return (
        ...
        >
            ...
            >
                ...
                <DetailSection title="About">{pharmacy.about}</DetailSection>
            </Box>
        </Dialog>
    );
};
